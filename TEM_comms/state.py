...
class Current(BaseMessage):
    ...
    """
    state: str = Field(description="The current state of the orchastration state machine.")
...
class Change(BaseMessage):
    ...
    """
    old: str = Field(description="The previous state of the orchastration state machine.")
